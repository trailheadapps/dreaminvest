...
export function sendMessage(userMsg: any): void;

export function addErrorHandler(handler: (errorMsg: string) => void): void;

export function removeErrorHandler(handler: (errorMsg: string) => void): void;

export function addMessageHandler(handler: (userMsg: any) => void): void;

export function removeMessageHandler(handler: (userMsg: any) => void): void;

export function getRESTAPISessionKey(): string;
