...
import classNames from 'classnames'; // ### assign

import assign from 'lodash.assign'; // ### reject
...
import DataTableRowActions from './row-actions'; // ## Constants
...
var DataTable = createReactClass({
  ...
  render: function render() {
    ...
    return React.createElement("table", {
      ...
      columns: columns,
      id: "".concat(this.props.id, "-").concat(DATA_TABLE_HEAD),
      onToggleAll: this.handleToggleAll,
      onSort: this.props.onSort,
      showRowActions: !!RowActions
    }), React.createElement("tbody", null, numRows > 0 ? this.props.items.map(function (item) {
      var rowId = "".concat(_this.props.id, "-").concat(DATA_TABLE_ROW, "-").concat(item.id) || shortid.generate();
