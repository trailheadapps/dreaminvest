...
import checkProps from './check-props'; // ### Traits
// #### KeyboardNavigable
...
var MenuDropdown = createReactClass({
  ...
  renderDefaultMenuContent: function renderDefaultMenuContent(customListProps) {
    return React.createElement(List, _extends({
      key: "".concat(this.getId(), "-dropdown-list"),
  ...
  renderInlineMenu: function renderInlineMenu(customContent, isOpen) {
    ...
    if (this.props.nubbinPosition) {
      ...
      positionClassName = classNames("slds-nubbin--".concat(positions.join('-')), positions.map(function (position) {
        return "slds-dropdown--".concat(position);
      ...
      positionClassName = "slds-dropdown--".concat(this.props.align);
    }
    ...
    }, this.renderMenuContent(customContent)) : null;
  },
  renderDialog: function renderDialog(customContent, isOpen, outsideClickIgnoreClass) {
    ...
    if (this.props.nubbinPosition) {
      ...
      marginTop = 0; // TODO: allow nubbinPosition prop to set the offset automatically
      // if (this.props.nubbinPosition === 'top right') {
      // 	offset = '-12px -24px';
      // }
    } else if (this.props.align) {
    ...
    return isOpen ? React.createElement(Dialog, {
      ...
      closeOnTabKey: true,
      contentsClassName: classNames('slds-dropdown', 'ignore-react-onclickoutside', positionClassName, this.props.className),
      ...
      style: this.props.menuStyle || assign({}, this.props.menuStyle, {
        marginTop: marginTop
      }),
