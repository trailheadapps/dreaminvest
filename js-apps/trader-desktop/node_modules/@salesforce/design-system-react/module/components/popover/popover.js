...
import Dialog from '../utilities/dialog'; // ### Traits

import { getMargin, getNubbinClassName } from '../../utilities/dialog-helpers'; // #### KeyboardNavigable
...
var Popover = createReactClass({
  ...
  propTypes: {
     ...
     */
    align: PropTypes.oneOf(['top', 'top left', 'top right', 'right', 'bottom', 'bottom left', 'bottom right', 'left']),
  ...
  setContainerRef: function setContainerRef(component) {
    this.trigger = component; // yes, this is a re-render triggered by a render.
  ...
  renderDialog: function renderDialog(isOpen, outsideClickIgnoreClass) {
    ...
    return isOpen ? React.createElement(Dialog, {
      ...
      "aria-labelledby": this.props.ariaLabelledby ? this.props.ariaLabelledby : "".concat(this.getId(), "-dialog-heading"),
      "aria-describedby": "".concat(this.getId(), "-dialog-body"),
      className: classNames('slds-popover', getNubbinClassName(props.align), props.className),
      id: "".concat(this.getId(), "-popover"),
      role: "dialog",
      style: assign({
        outline: '0'
      }, style),
      ...
      variant: "icon"
    }), this.props.heading ? React.createElement("header", {
      className: "slds-popover__header"
    }, React.createElement("h2", {
      id: "".concat(this.getId(), "-dialog-heading"),
      className: "slds-text-heading--small"
    }, this.props.heading)) : null, React.createElement("div", {
      id: "".concat(this.getId(), "-dialog-body"),
      className: "slds-popover__body"
    }, props.body), this.props.footer ? React.createElement("footer", {
  ...
  render: function render() {
    ...
    var clonedTrigger = this.props.children ? React.cloneElement(this.props.children, _objectSpread({
      id: this.getId(),
