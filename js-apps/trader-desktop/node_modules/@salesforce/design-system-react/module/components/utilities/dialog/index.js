...
var Dialog = createReactClass({
  ...
  getPopperStyles: function getPopperStyles() {
    ...
    var left = "".concat(popperData.offsets.popper.left + propOffsets.horizontal, "px");
    var top = "".concat(popperData.offsets.popper.top + propOffsets.vertical, "px"); // A Dropdown with overflowBoundaryElement position and 'align=right' uses max-width instead of inherited children width
  ...
  createPopper: function createPopper() {
    ...
    var placement = mapPropToPopperPlacement(this.props.align);
  ...
  render: function render() {
    ...
    var contents = React.createElement("div", _extends({
      ...
      }, "".concat(this.props.outsideClickIgnoreClass), this.props.position === 'overflowBoundaryElement'), this.props.contentsClassName) || undefined,
      style: style,
