...
var GlobalHeaderDropdownTrigger = createReactClass({
  ...
  render: function render() {
    ...
    var _props = this.props,
        ...
        rest = _objectWithoutProperties(_props, ["avatar", "className", "id", "isOpen", "globalAction", "menu", "onBlur", "onClick", "onFocus", "onKeyDown", "onMouseDown", "onMouseEnter", "onMouseLeave", "triggerRef"]); // TODO: Add avatar component for use across multiple components
    ...
    return (
      ...
      React.createElement("li", {
        "aria-haspopup": "true",
        className: classnames('slds-dropdown-trigger slds-dropdown-trigger--click', {
          'slds-is-open': isOpen,
        ...
        "aria-haspopup": "true"
      }, rest), avatar ? React.createElement("span", {
