...
import GlobalHeaderTrigger from './private/dropdown-trigger'; // ## Constants
...
var GlobalHeaderProfile = function GlobalHeaderProfile(props) {
  var avatar = props.avatar,
      ...
      rest = _objectWithoutProperties(props, ["avatar", "buttonClassName", "children"]);
  ...
  return (// `slds-m-right--x-small` is present to prevent dropdown menu with a
