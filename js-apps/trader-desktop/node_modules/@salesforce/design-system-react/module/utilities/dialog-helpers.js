...
var getAlignment = {}; // `indexOf` is used becauses `align` can be a string OR an array at this time.
...
export { getMargin, getAlignment, getNubbinClassName, mapPropToPopperPlacement };
